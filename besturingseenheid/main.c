...
int main(void)
{
	...
	SCH_Add_Task(Light, 0, 200); // Voeg taken toe aan de scheduler Light zit op A0.
	//SCH_Add_Task(settingsChecker, 0, 200); // misschien om de minuut
	SCH_Add_Task(serialReactor,0,100);
